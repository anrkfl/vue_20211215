    ...
    export default {
        ...
        methods : {
            async handleData(){
                // 백엔드에서 데이터를 받았다고 가정
                this.items =[
                    {id:'a', age:31, price:123, cnt:99},
                    {id:'b', age:41, price:234, cnt:70},
                    {id:'c', age:51, price:345, cnt:5},
                    {id:'d', age:61, price:456, cnt:55},
                    {id:'e', age:71, price:567, cnt:9},
                ];
            ...
            handleCheck(idx){
                console.log('Table1.vue => handleChked',idx);
                if(this.items[idx].chk ===true){
                    this.items[idx].sum = this.items[idx].price *this.items[idx].cnt1
                }
